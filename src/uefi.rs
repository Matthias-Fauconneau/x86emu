...
pub fn new_file_impl() -> FileImpl { FileImpl {
    ...
    delete: {extern "efiapi" fn f(_this: &mut FileImpl) -> Status {unimplemented!() } f},
    read: {extern "efiapi" fn f(_this: &mut FileImpl, _buffer_size: &mut usize, _buffer: *mut u8) -> Status { unimplemented!() } f},
    write: {extern "efiapi" fn f(_this: &mut FileImpl, _buffer_size: &mut usize, _buffer: *const u8) -> Status { unimplemented!() } f},
    get_position: {extern "efiapi" fn f(_this: &mut FileImpl, _position: &mut u64) -> Status { unimplemented!() } f},
    set_position: {extern "efiapi" fn f(_this: &mut FileImpl, _position: u64) -> Status { unimplemented!() } f},
    get_info: {extern "efiapi" fn f(_this: &mut FileImpl, _information_type: &Guid, _buffer_size: &mut usize, _buffer: *mut u8) -> Status { unimplemented!() } f},
    set_info: {extern "efiapi" fn f(_this: &mut FileImpl, _information_type: &Guid, _buffer_size: usize, _buffer: *const c_void) -> Status { unimplemented!() } f},
    flush: {extern "efiapi" fn f(_this: &mut FileImpl) -> Status { unimplemented!() } f},
} }
