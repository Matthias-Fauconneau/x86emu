...
use {std::{ptr::{null, null_mut}, ffi::c_void}, uefi::{Status, data_types::{Guid, Handle, chars::Char16, Event},
                proto::{console::text::{RawKey, OutputData, Input, Output}, loaded_image::LoadedImage},
...
pub fn new_output(output_data : &OutputData) -> Output { Output{
    ...
    output_string: {unsafe extern "efiapi" fn i(_this: &Output, _string: *const Char16) -> Status { unimplemented!() } i},
    test_string: {unsafe extern "efiapi" fn i(_this: &Output, _string: *const Char16) -> Status { unimplemented!() } i},
...
pub fn new_runtime_services() -> RuntimeServices { RuntimeServices{ header: Header{ signature:0, revision:Revision(0), size:0, crc:0, _reserved:0 },
    get_time: {unsafe extern "efiapi" fn i(_time: *mut Time, _capabilities: *mut TimeCapabilities) -> Status { unimplemented!() } i},
    set_time: {unsafe extern "efiapi" fn i(_time: &Time) -> Status { unimplemented!() } i},
    _pad: [0; 2],
    set_virtual_address_map: {unsafe extern "efiapi" fn i(_map_size: usize, _desc_size: usize, _desc_version: u32, _virtual_map: *mut MemoryDescriptor) -> Status { unimplemented!() } i},
    _pad2: [0; 5],
    reset: {unsafe extern "efiapi" fn i(_rt: ResetType, _status: Status, _data_size: usize, _data: *const u8) -> ! { unimplemented!() } i}
}}
...
pub fn new_boot_services() -> BootServices { BootServices{ header : Header{ signature:0, revision:Revision(0), size:0, crc:0, _reserved:0 },
    raise_tpl: {unsafe extern "efiapi" fn i(_new_tpl: Tpl) -> Tpl { unimplemented!(); } i},
    restore_tpl: {unsafe extern "efiapi" fn i(_old_tpl: Tpl) { unimplemented!(); } i},
    ...
    get_memory_map:
        {unsafe extern "efiapi" fn i(_size: &mut usize, _map: *mut MemoryDescriptor, _key: &mut MemoryMapKey, _desc_size: &mut usize, _desc_version: &mut u32)
    ...
    create_event: {unsafe extern "efiapi" fn i(_ty: EventType, _notify_tpl: Tpl, _notify_func: Option<EventNotifyFn>, _notify_ctx: *mut c_void, _event: *mut Event) -> Status
        { unimplemented!(); } i},
    set_timer: {unsafe extern "efiapi" fn i(_event: Event, _ty: u32, _trigger_time: u64) -> Status { unimplemented!() } i},
    wait_for_event: {unsafe extern "efiapi" fn i(_number_of_events: usize, _events: *mut Event, _out_index: *mut usize) -> Status { unimplemented!(); } i},
    signal_event: 0,
    close_event: 0,
    check_event: 0,
    ...
    locate_handle: {unsafe extern "efiapi" fn i(_search_ty: i32, _proto: *const Guid, _key: *mut c_void, _buf_sz: &mut usize, _buf: *mut Handle) -> Status
        { unimplemented!(); } i},
    ...
    exit: 0,
    unload_image: 0,
    exit_boot_services: {unsafe extern "efiapi" fn i(_image_handle: Handle, _map_key: MemoryMapKey) -> Status { unimplemented!(); } i},
    get_next_monotonic_count: 0,
    set_watchdog_timer: {unsafe extern "efiapi" fn i(_timeout: usize, _watchdog_code: u64, _data_size: usize, _watchdog_data: *const u16) -> Status { unimplemented!(); } i},
    ...
    calculate_crc32: 0,
    copy_mem: {unsafe extern "efiapi" fn i(_dest: *mut u8, _src: *const u8, _len: usize) { unimplemented!(); } i},
    set_mem: {unsafe extern "efiapi" fn i(_buffer: *mut u8, _len: usize, _value: u8) { unimplemented!(); } i},
    create_event_ex: 0,
} }
